...
import com.example.android4a.presentation.Adapter.PokemonEvolutionAdapter
import com.example.android4a.presentation.Adapter.PokemonTypeAdapter
...
class PokemonDetail : Fragment() {
    ...
    private fun setDetailPokemon(pokemon: Pokemon?) {
        ...
        val weeknessAdapter = PokemonTypeAdapter(activity!!, pokemon.weaknesses!!)
        recycler_weakness.adapter = weeknessAdapter
